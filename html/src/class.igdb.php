<?php
    ...
    /**
     * I Juan Casimiro am not the one that created this, I used it in this project with the help of Enisz Abdalla.
     * https://github.com/enisz     https://github.com/enisz/igdb/blob/master/src/class.igdb.php
    ...
    class IGDB {
        ...
        public function cover($options, $execute = true)
        {
            return $execute ? $this->_exec_query($this->_construct_url('covers', $options)) : $this->_construct_url('covers', $options);
        }
        /**
